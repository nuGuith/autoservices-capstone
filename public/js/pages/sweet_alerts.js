...
$(document).ready(function () {
    ...
    $('.examples .warning.cancel_add').on('click', function () {
        swal({
            title: 'Are you sure?',
            text: 'The record is about to be saved.',
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#00c0ef',
            cancelButtonColor: '#ff8080',
    ...
    $('.examples .warning.cancel_edit').on('click', function () {
        swal({
            title: 'Are you sure?',
            text: 'The changes you\'ve made are about to be saved.',
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#00c0ef',
            cancelButtonColor: '#ff8080',
    ...
    $('.examples .success_clr_edit').on('click', function () {
        swal('Are you sure?', 'You will not be able to recover this imaginary file!').done();
        swal({
            title: 'Successful!',
            text: 'The changes have been saved successfully!',
    ...
    $('.examples .warning.confirm').on('click', function (e) {
        swal({
            title: 'Are you sure?',
