...
<?php $__env->startSection('content'); ?>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset('vendors/modal/css/component.css')); ?>"/>
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset('vendors/bootstrap-tagsinput/css/bootstrap-tagsinput.css')); ?>"/>
                                        ...
                                        <table class="table table-bordered table-hover table-advance dataTable no-footer" style="border-radius: 10px;" id="editable_table" role="grid">
                                            ...
                                            <tbody>
                                              <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($type->InspectionTypeName); ?></td>
                                                    <td>
                                                        ...
                                                        <ul style="padding-left: 1.2em;">
                                                          ...
                                                          <?php if($i->InspectionTypeID == $type->InspectionTypeID): ?>

                                                          <li><?php echo e($i->InspectionItem); ?></li>
                                                    ...
                                                    <td>
                                                        <!--EDIT BUTTON-->
                                                        <button name = '<?php echo e($type->InspectionTypeID); ?>' onclick="updateIC(this.name)"  class="btn btn-success hvr-float-shadow adv_cust_mod_btn tipso_bounceIn" data-background="#3CB371" data-color="white" data-tipso="Edit" data-toggle="modal" data-href="#responsive" href="#editModal"><i class="fa fa-pencil text-white"></i>
                                                        </button>

                                                        <!--DELETE BUTTON-->
                                                        <button name = '<?php echo e($type->InspectionTypeID); ?>' onclick="deleteIC(this.name)"  class="btn btn-danger hvr-float-shadow tipso_bounceIn" data-background="#FA8072" data-color="white" data-tipso="Delete"><i class="fa fa-trash text-white"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
