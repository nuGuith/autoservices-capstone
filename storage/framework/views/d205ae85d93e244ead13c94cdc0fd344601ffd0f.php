    ...
    <!-- <link type="text/css" rel="stylesheet" href="css/pages/advanced_components.css"/> -->
        ...
        <div id="content" class="bg-container">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!--EDIT BUTTON-->
                                                        <button class="btn btn-success hvr-float-shadow adv_cust_mod_btn" onclick="editModal(<?php echo $category->ServiceCategoryID; ?>)" data-toggle="modal" data-href="#responsive" type="button"><i class="fa fa-pencil text-white"></i>&nbsp; Edit
                                                        </button>
                                                        <!--DELETE BUTTON-->
                                                        <!-- <?php echo e(Form::open(array('url' => 'servicecategory/' . $category->ServiceCategoryID, 'action' => 'ServiceCategoryController@destroy', 'method' => 'DELETE'))); ?>

                                                        <?php echo e(Form::submit('Delete', array('class' => 'btn btn-danger'))); ?>

                                                        <?php echo e(Form::close()); ?> -->
                                                        <button class="btn btn-danger source warning confirm hvr-float-shadow" onclick="deleteModal(<?php echo $category->ServiceCategoryID; ?>)" type="button" style="width:70px"><i class="fa fa-trash text-white"></i> &nbsp; Delete
                                                        </button>
                                                    </td>
                                                </tr>
            ...
            <!-- START EDIT MODAL -->
                            ...
                            <div class="modal-body">
                                <div class="col">
                                    <div class="col-xl-12" style="padding-right:25px;">
                                        ...
                                        <p>
                                            <?php echo Form::input ('servicecategoryname','text', null, [
                ...
                <!-- START DELETE MODAL -->
                <?php echo Form::open(array('id' => 'deleteForm', 'url' => 'servicecategory', 'action' => 'ServiceCategoryController@delete', 'method' => 'PATCH')); ?>
