    ...
    <!-- <link type="text/css" rel="stylesheet" href="css/pages/advanced_components.css"/> -->
        ...
        <div id="content" class="bg-container">
            ...
            <header class="head">
                        ...
                        <div class="card">
                            <div class="card-header bg-dark">
                                <div class="btn-group">
                                        ...
                                        <!--ADD BUTTON MODAL-->
                                        <a  id="editable_table_new" class=" btn btn-raised btn-default hvr-pulse-grow adv_cust_mod_btn" data-toggle="modal"
                                                   data-href="#responsive" href="#addvehicle">
             ...
             <!--- responsive addvehicle modal -->
                <div class="modal fade in " id="addvehicle" tabindex="-1" role="dialog" aria-hidden="false">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <h4 class="modal-title text-white">Add Vehicle Type</h4>
                            ...
                            <div class="modal-footer">
                              <div class="examples transitions m-t-5">
                                ...
                                <div class="examples transitions m-t-5">
                                    <button class="btn btn-success  source success_clr m-l-5 hvr-float-shadow adv_cust_mod_btn" data-dismiss="modal"><i class="fa fa-save text-white"></i>&nbsp; Save
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal fade in " id="editvehicle" tabindex="-1" role="dialog" aria-hidden="false">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <h4 class="modal-title text-white">Edit Vehicle Type</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            ...
                            <div class="modal-footer">
                              <div class="examples transitions m-t-5">
                                ...
                                <div class="examples transitions m-t-5">
                                    <button class="btn btn-success source success m-l-10 hvr-float-shadow adv_cust_mod_btn" data-dismiss="modal"><i class="fa fa-save text-white"></i>&nbsp; Save Changes
                                    </button>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="checkbox" class="form-control" name="automatic"' + counter + '"/></td>';
        cols += '<td><input type="checkbox" class="form-control" name="manual"' + counter + '"/></td>';
