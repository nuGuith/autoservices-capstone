                    ...
                    <div class="inner bg-container">
                        <div class="card">
                            ...
                            <div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!--DELETE BUTTON-->
                                                        <!-- <?php echo e(Form::open(array('url' => 'servicebay/' . $bay->ServiceBayID, 'action' => 'ServiceBayController@destroy', 'method' => 'DELETE'))); ?>
                                ...
                                <!-- END TABLE -->
            <!-- START EDIT MODAL -->
            <?php echo Form::open(array('id' => 'editForm', 'method' => 'PUT', 'url' => 'servicebay', 'action' => 'ServiceBayController@update')); ?>
