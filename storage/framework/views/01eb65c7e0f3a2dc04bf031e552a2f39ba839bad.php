 <!-- Include Master Page -->
<?php $__env->startSection('Title','Add Service Category'); ?> <!-- Page Title -->
                    ...
                    <div class="inner bg-container">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card" >
                                    ...
                                    <div class="card-header bg-primary disabled text-white" ><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Service Category</div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <p>
                                            <input id="name" name="category" type="text" placeholder="Category"
                            ...
                            <div class="card-footer bg-black disabled">
                               <div class="examples transitions m-t-5 pull-right">
                                    <button onclick="window.location='<?php echo e(url("/servicecategory")); ?>'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn"  href="/servicecategory">Back</button>                
