 <!-- Include MAster PAge -->
<?php $__env->startSection('Title','Package'); ?> <!-- Page Title -->
                        ...
                        <div class="card">
                            ...
                            <div>
                                        <table class="table table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                            ...
                                            <tbody>
                                            <?php $__currentLoopData = $pack; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($cb->isActive == 1): ?>
                                                <tr role="row" class="even">
                                                    <td hidden><?php echo e($cb->PackageID); ?></td>
                                                    <td><?php echo e($cb->PackageName); ?></td>
                                                    
                                                    <td class="center">
                                                        <b>Products:</b>
                                                        <ul>
                                                            <?php $__currentLoopData = $pr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                              <?php if($prod->PackageID == $cb->PackageID): ?>

                                                             <li><?php echo e($prod->ProductName); ?></li>
                                                        ...
                                                        <b>Services:</b>
                                                        <ul>
                                                            <?php $__currentLoopData = $sr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                              <?php if($ser->PackageID == $cb->PackageID): ?>

                                                             <li><?php echo e($ser->ServiceName); ?></li>
