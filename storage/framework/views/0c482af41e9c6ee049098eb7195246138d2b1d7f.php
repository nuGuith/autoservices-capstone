 <!-- Include MAster PAge -->
<?php $__env->startSection('Title','Add Product Type'); ?> <!-- Page Title -->
<?php $__env->startSection('content'); ?>

    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/vendors/jquery-tagsinput/css/jquery.tagsinput.css')); ?>"/>
                                ...
                                <div class="card-header bg-primary disabled text-white" >
                                    ...
                                    <div class="card-footer bg-black disabled">
                                        <div class="examples transitions m-t-5 pull-right">
                                            <button onclick="window.location='<?php echo e(url("/producttype")); ?>'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn"  href="/producttype">Back</button>                
...
<script type="text/javascript" src="<?php echo e(asset('assets/vendors/jquery-tagsinput/js/jquery.tagsinput.js')); ?>"></script>
