 <!-- Include MAster PAge -->
<?php $__env->startSection('Title','Personnel'); ?> <!-- Page Title -->
                                        ...
                                        <table class="table  table-striped table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1" style="width: 35%;"><b>Personnel</b></th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1" style="width: 35%;"><b>Job Description</b></th>
                                            ...
                                            <tbody>
                                                <tr role="row" class="even">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-success hvr-float-shadow adv_cust_mod_btn" data-toggle="modal" data-href="#responsive" href="/ViewMechanic"><i class="fa fa-eye text-white"></i>&nbsp; View
                                                        </button>
