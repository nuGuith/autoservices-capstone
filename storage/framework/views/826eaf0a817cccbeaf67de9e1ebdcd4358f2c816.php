 <!-- Include MAster PAge -->
<?php $__env->startSection('Title','Add Product'); ?> <!-- Page Title -->
                            ...
                            <div class="card-header bg-primary disabled text-white" ><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Product</div>
                                ...
                                <div class="card-footer bg-black disabled">
                                    <div class="examples transitions m-t-5 pull-right">
                                        <button onclick="window.location='<?php echo e(url("/product")); ?>'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn" href="/product">Back</button>    <button class="btn btn-success  source success_clr m-l-0 hvr-float-shadow adv_cust_mod_btn" style ="width: 80px;" >
