...
@section('Title','Inspection Report') <!-- Page Title -->
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header default_bg_dark">
                            <div align="center" class="m-t-10">
                                <h3> INSPECTION TRANSACTIONS REPORT </h3>
                                <h4 id="reportdate"></h3>
                            </div>
                        </div>
                            <div class="card-block m-t-5" id="user_body">
                                ...
                                <table class="table table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1" style="width: 12%;"><b>INSPECTION ID</b></th>
                    ...
                    <!-- FOOTER -->
                        <div class="card-footer bg-black disabled">
                            <div class="examples transitions m-t-5 pull-right">
                                <div class="btn-group">
                                    <a href="{{url('/report-inspection')}}" target="_blank">
