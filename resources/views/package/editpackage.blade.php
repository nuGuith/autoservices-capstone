...
@section('Title','Edit Package') <!-- Page Title -->
@section('content')
                ...
                <div class="main-bar">
                    ...
                    <div class="col-sm-6 col-12"  >
                        <ol  class="breadcrumb float-right   ">
                            ...
                            <li class="active breadcrumb-item">&nbsp;Edit Package</li>
                        </ol>
                    </div>
                ...
                <div class="inner bg-container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-header bg-primary disabled text-white" ><i class= "fa fa-pencil"></i>&nbsp;&nbsp;Edit Package</div>
