                        ...
                        <div class="card-block m-t-15">                
                            ...
                            <div class="row m-t-15">
                                    <div class="col-lg-4">
                                            ...
                                            <p>
                                                {!! 
                                                    Form::input ('firstname','text', Input::old('firstname'), [
                                                    'id'=>'firstname',
                                                    'name'=>'firstname',
                                                    'type'=>'text',
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <p>
                                                {!! 
                                                    Form::input ('middlename','text', Input::old('middlename'), [
                                                    'id'=>'middlename',
                                                    'name'=>'middlename',
                                                    'type'=>'text',
                                        ...
                                        <div class="col-lg-4 ">
                                            ...
                                            <p>
                                                {!! 
                                                    Form::input ('lastname','text', Input::old('lastname'), [
                                                    'id'=>'lastname',
                                                    'name'=>'lastname',
                                                    'type'=>'text',
                                ...
                                <div class="row m-t-5">
                                    <div class="col-lg-4 ">
                                            ...
                                            <p>
                                                {!! 
                                                    Form::input ('contactno','text', Input::old('contactno'), [
                                                    'id'=>'contactno',
                                                    'name'=>'contactno',
                                                    'type'=>'text',
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <p>
                                                {!! 
                                                    Form::input ('emailaddress','text', Input::old('emailaddress'), [
                                                    'id'=>'emailaddress',
                                                    'name'=>'emailaddress',
                                                    'type'=>'text',
                                ...
                                <div class="form-group row m-t-0">
                                    <div class=" col-lg-1  m-t-15">
                                        ...
                                        <div class="col-md-12 col-lg-11">                                        
                                            <p>
                                                {!! 
                                                    Form::input ('completeaddress','text', Input::old('completeaddress'), [
                                                    'id'=>'completeaddress',
                            ...
                            <div class="row m-t-15">
                                    <div class="col-lg-3">
                                            ...
                                            <p>
                                                {!! 
                                                    Form::input ('plateno','text', Input::old('plateno'), [
                                                    'id'=>'plateno',
                                                    'name'=>'plateno',
                                                    'type'=>'text',
                                        ...
                                        <div class="col-lg-3 ">
                                           <h5>Chassis No.: <span style="color: red">*</span></h5>
                                            <p>
                                                {!! 
                                                    Form::input ('chassisno','text', Input::old('chassisno'), [
                                                    'id'=>'chassisno',
                                                    'name'=>'chassisno',
                                                    'type'=>'text',
                                        ...
                                        <div class="col-lg-3 ">
                                            <h5>Mileage: <span style="color: red">*</span></h5>
                                                <div class="input-group">
                                                    ...
                                                    {!! 
                                                        Form::input ('mileage','text', Input::old('mileage'), [
                                                        'id'=>'mileage',
                                                        'name'=>'mileage',
                                                        'type'=>'text',
                                                        'placeholder'=>'Mileage',
                                ...
                                <div class="row m-t-5">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <p class="m-t-10">
                                                {{ Form::select('servicebayid', $categories, null, array(
