                        ...
                        <div class="card">
                            <div class="card-header bg-dark">
                                <div class="btn-group">
                                    ...
                                    <!--ADD BUTTON MODAL-->
                                    <a  id="editable_table_new" class=" btn btn-raised btn-default hvr-pulse-grow adv_cust_mod_btn" data-toggle="modal" data-href="#responsive" href="#addModal"><i class="fa fa-plus"></i>
                                        &nbsp;  Add Product Type                                 
                                    </a>
                                </div>
                             </div>
                                            ...
                                            @foreach ($producttypes as $producttype)
                                                <tr role="row" class="even">                  
                                                    ...
                                                    <td>
                                                        ...
                                                        <!--EDIT BUTTON-->
                                                        <button class="btn btn-success hvr-float-shadow adv_cust_mod_btn tipso_bounceIn" onclick="editModal({!!$producttype->ProductTypeID!!}); setSelected({!!$ctr!!});" data-background="#3CB371" data-color="white" data-tipso="Edit" data-toggle="modal" data-href="#responsive" href="#editModal"><i class="fa fa-pencil text-white"></i>
                                                        </button>
