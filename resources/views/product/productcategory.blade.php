                                    ...
                                    @foreach($productcategories as $productcategory)
                                        <tr>                                
                                            ...
                                            <td class="examples transitions">
                                                <!--EDIT BUTTON-->
                                                <button class="btn btn-success hvr-float-shadow adv_cust_mod_btn tipso_bounceIn" onclick="editModal({!!$productcategory->ProductCategoryID!!})" data-background="#3CB371" data-color="white" data-tipso="Edit" data-toggle="modal" data-href="#responsive" href="#editModal">
                                                    <i class="fa fa-pencil text-white"></i>
                                                </button>
                                                <!--DELETE BUTTON-->
                                                <button class="btn btn-danger hvr-float-shadow tipso_bounceIn" onclick="deleteModal({!!$productcategory->ProductCategoryID!!})" data-background="#FA8072" data-color="white" data-tipso="Delete">
        ...
        fields: {
            categoryname: {
                ...
                validators: {
                    ...
                    regexp: {
                        regexp: /[^a-z ]/g,'',
                        message: 'The service category name only accept alphabet values. '
                    },
                }
            },
        }
