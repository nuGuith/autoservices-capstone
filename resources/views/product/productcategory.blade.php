                                        ...
                                        <table class="table table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!--EDIT BUTTON-->
                                                        <button class="btn btn-success hvr-float-shadow adv_cust_mod_btn" onclick="editModal({!!$productcategory->ProductCategoryID!!})" data-toggle="modal" data-href="#responsive" data-categoryname="{{$productcategory->CategoryName}}" type="button"><i class="fa fa-pencil text-white"></i>&nbsp; Edit
                                                        </button>
