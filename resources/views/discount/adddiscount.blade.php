...
@section('Title','Add Discount') <!-- Page Title -->
@section('content')
                            ...
                            <div class="card-block">
                             ...
                             <div class="card-footer bg-black disabled">
                               <div class="examples transitions m-t-5 pull-right">
                                    <button onclick="window.location='{{ url("/vehicletype") }}'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn gray"  href="/vehicletype"><i class="fa fa-arrow-left" >
                                    </i>&nbsp;Back</button>                
