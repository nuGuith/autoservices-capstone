                                    ...
                                    <table class="table table-bordered table-hover dataTable" id="sample_6" role="grid" aria-describedby="sample_6_info" style="top:30px;" >
                                        <thead>
                                            ...
                                            <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <button type="button" id="updateBtn1"  class="btn btn-outline-info tipso_bounceIn" data-background=" #6495ED" data-color="white" data-tipso="View"  data-toggle="modal" data-href="#responsive" href="#viewModal" ><i class="fa fa-eye text-green"></i></button>

                                                         <button type="button"   class="btn btn-outline-success tipso_bounceIn" data-background="#3CB371" data-color="white" data-tipso="Edit" data-toggle="modal" data-href="#responsive" href="#editModal" ><i class="fa fa-pencil text-green"></i></button>       
                                                    </td>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        ...
                        <h4 class="modal-title text-white"><i class="fa fa-eye"></i>
                                    &nbsp;View Vehicle History</h4>
                    </div>
                                    ...
                                    <div class="accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                            ...
                                            <div class="card-header" role="tab" id="headingOne">
                                                <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne" aria-expanded="" aria-controls="collapseOne" active="false">
                                                    ...
                                                    <h5 class="">
                                                        ...
                                                        <span style="color:gray">JOB0002<i style="padding-left: 270px;"></i><b> September 7, 2018</b></span>
                                                    </h5>
                                                </a>
                                            </div>
                                        ...
                                        <div class="row m-t-10 m-b-20">  
                                            <div class="col-lg-12">
                                                ...
                                                </span>&nbsp;&nbsp;The quick brown fox jumpover the lazy dog.</h5>
                                            </div>               
                                        </div>
                                            ...
                                            <div class="card-header" role="tab" id="headingTwo">
                                                <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo" aria-expanded="" aria-controls="collapseTwo" active="false">
                                                    ...
                                                    <h5 class="">
                                                        <i class="fa fa-angle-down rotate-icon pull-right"></i>
                                                        <span style="color:gray">JOB0001<i style="padding-left: 270px;"></i><b> October 7, 2018</b></span>
                                                    </h5>
                                                </a>
                                            </div>
                            ...
                            <div class="row m-t-10 m-l-10" style="padding-right: 30px;">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="checkbox-rotate m-t-15">
                        ...
                        <button class="btn btn-success source success_clr m-l-0 hvr-float-shadow adv_cust_mod_btn" style ="width: 80px;"  ><i class="fa fa-save text-white" ></i>&nbsp; Save</button>
                             ...
                             <div class="card-footer bg-black disabled m-t-15">
                               <div class="examples transitions m-t-5 pull-right">
                                    <button onclick="window.location='{{ url("/vehicleinformation") }}'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn gray"  href="/vehicletype"><i class="fa fa-arrow-left" >
                                    </i>&nbsp;Back</button>  
