...
@section('Title','Add Service Category') <!-- Page Title -->
@section('content')
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-footer bg-black disabled">
                               <div class="examples transitions m-t-5 pull-right">
                                    <button onclick="window.location='{{ url("/servicecategory") }}'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn"  href="/servicecategory">Back</button>                
