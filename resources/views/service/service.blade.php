                            ...
                            <div class="modal-body" style="padding-left: 47px;">
                                <div class="row m-t-5">
                                    <div class="col-md-11">
                                        ...
                                        <p>
                                            <input id="servicename" name="servicename" disabled="disabled" type="text" placeholder="Service Name" maxlength="255" required="required" class="form-control m-t-10">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="row m-t-5">
                                    <div class="col-md-11">
                                        ...
                                        <p>
                                            <input type="text" id="servicecategory" name="servicecategory" disabled="disabled" placeholder="Service Category" class="form-control m-t-10"/>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="row m-t-5">
                                    <div class="col-md-11">
                                        ...
                                        <p>
                                            <input type="text" id="estimatedtime" name="estimatedtime" placeholder="Estimated Time" class="form-control m-t-10"/>
                                        </p>
                                    </div>
                                </div>
