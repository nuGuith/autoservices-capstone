                            ...
                            <tbody>
                                <tr role="row" class="even">
                                    ...
                                    <div class="examples transitions m-t-5">
                                        <!--VIEW BUTTON-->
                                        <button class="btn btn-primary hvr-float-shadow tipso_bounceIn" data-background=" #6495ED" data-color="white" data-tipso="View" onclick="window.location='  {{ url("/viewjoborder") }}'" ><i class="fa fa-eye text-white"></i></button>


                                        <!--UPDATE BUTTON-->
                                        <button class="btn btn-info hvr-float-shadow  tipso_bounceIn" style ="width:;"data-background="blue" data-color="white" data-tipso="Update" onclick="window.location='{{ url("/updatejoborder") }}'"><i class="fa fa-refresh text-white"></i>
                                        </button>


                                        <!--EDIT BUTTON-->
                                        <button class="btn btn-success hvr-float-shadow adv_cust_mod_btn tipso_bounceIn" data-background="#3CB371" data-color="white" data-tipso="Edit" onclick="window.location='{{ url("/editjoborder") }}'"><i class="fa fa-pencil text-white"></i>
                                        </button>
