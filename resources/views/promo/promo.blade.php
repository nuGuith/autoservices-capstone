                                        ...
                                        <table class="table table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1" style="width: 30%;"><b>Product and Services</b></th>
                ...
                <div class="input-group">
                    <div class="col-md-7 m-t-15">
                        ...
                        <p>
                             ...
                             <input id="eid" hidden>
                            <input id="promoname" name="promoname" type="text" placeholder="Promo Name" class="form-control  m-t-5" style = "width: 210px;" >
                        </p>
                    </div>
                    ...
                    <div class="col-md-5 m-t-15">
                        ...
                        <div class="input-group m-t-5" style = "width: 139px;" >
                            <input id="computePrice" type="text" class="form-control" disabled="disabled" placeholder ="Php.">
                ...
                <div class="input-group">
                    ...
                    <div class="col-md-8 m-t-5">
                        ...
                        <div class="input-group" >
                            ...
                            <input id = "promoprice" type="text" class="form-control" style = "width: 100px;" placeholder ="Php";>
