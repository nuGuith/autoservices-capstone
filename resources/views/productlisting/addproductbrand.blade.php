...
@section('Title','Add Product Brand') <!-- Page Title -->
@section('content')
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-footer bg-black disabled">
                                <div class="examples transitions m-t-5 pull-right">
                                    <button onclick="window.location='{{ url("/productbrand") }}'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn" href="/productbrand">Back</button>
