...
@section('Title','Add Product Category') <!-- Page Title -->
@section('content')
                                ...
                                <div class="card-header bg-primary disabled text-white" >
                                    ...
                                    <div class="card-footer bg-black disabled">
                                        <div class="examples transitions m-t-5 pull-right">
                                            <button onclick="window.location='{{ url("/productcategory") }}'" class="btn btn-secondary hvr-float-shadow adv_cust_mod_btn"  href="/productcategory">Back</button>                
