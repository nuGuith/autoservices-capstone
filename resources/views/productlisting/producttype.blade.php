            ...
            <div class="inner bg-container">
                <div class="card">
                    <div class="card-header bg-dark">
                        <div class="btn-group">
                                        <!--ADD BUTTON MODAL-->
                            <a  id="editable_table_new" class=" btn btn-raised btn-default hvr-pulse-grow adv_cust_mod_btn" href="/addproducttype">
                            ...
                            <table class="table  table-striped table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                    <tr role="row">    
                                        ...
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1" style="width: 25%;"><b>Product Brand</b></th>
                                    ...
                                    <tr role="row" class="even">                                                    
                                        ...
                                        <td>
                                            ...
                                            <div class="examples transitions m-t-5">
                                                <button class="btn btn-success hvr-float-shadow adv_cust_mod_btn" data-toggle="modal" data-href="#responsive" href="#editproducttype"><i class="fa fa-pencil text-white"></i>
                                                &nbsp; Edit
                                                </button>
                                                <!--DELETE BUTTON-->
                ...
                <!-- EDIT PRODUCT TYPE-->
                <div class="modal fade in " id="editproducttype" tabindex="-1" role="dialog" aria-hidden="false">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-5"><br>
                                        ...
                                        <h4>Product Type</h4>
                                        <p><input id="name" name="type" type="text" placeholder="Type" class="form-control"></p>
