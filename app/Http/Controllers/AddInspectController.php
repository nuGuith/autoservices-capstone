...
class AddInspectController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $insp = Inspection::where('isActive', 1)
        ->select('*')
        ->get();
        ...
        return view('inspect.addinspect', compact('insp','inspects', 'checklists', 'estimateids', 'joborderids', 'personnels', 'service_bays'));
    }
